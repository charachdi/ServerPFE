module.exports = (sequelize, DataTypes) => {
    const Before  = sequelize.define("Before", {
    id:{
        allowNull: false,
        autoIncrement: true,
        primaryKey: true,
    ...
    Before.associate = function(models) { 
        Before.belongsTo(models.Files)
        Before.belongsTo(models.User)
        Before.belongsTo(models.CompteClient)
        Before.belongsTo(models.Requete)
        Before.belongsTo(models.Historique)
  };
